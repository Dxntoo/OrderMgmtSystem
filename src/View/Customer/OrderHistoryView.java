...
public class OrderHistoryView extends javax.swing.JFrame {
    ...
    private void loadTable(){
        ...
        ArrayList<Orders> orders = new OrderLoader().load(customer);
        for(int i = 0; i < orders.size(); i++){
            String orderId = orders.get(i).getOrderId();
            String orderItems = formatOrderItems(orders.get(i).getOrderedItems());
    ...
    private String formatOrderItems(ArrayList<OrderedItems> o){
        ...
        for (int i = 0; i < o.size(); i++) {
            ...
            if (i != o.size() - 1) {
                items += "(" + o.get(i).getItems().getItemName() + ","
                        + o.get(i).getQuantity() + "),  ";
            } else {
                items += "(" + o.get(i).getItems().getItemName() + ","
                        + o.get(i).getQuantity() + ")";
